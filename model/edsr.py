...
from model.quant_ops import conv3x3, quant_conv3x3_asym99

class DDTB_ResBlock(nn.Module):
...
class DDTB_EDSR(nn.Module):
    def __init__(self, args, conv=quant_conv3x3_asym99, bias=False, k_bits=32):
